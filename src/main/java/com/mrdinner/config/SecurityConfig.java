...
import com.mrdinner.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // 환경 변수에서 프론트엔드 URL 가져오기, 없으면 기본값 사용
        ...
        // 환경 변수에서 프론트엔드 URL이 있으면 추가
        if (frontendUrlEnv != null && !frontendUrlEnv.isEmpty()) {
            // 쉼표로 구분된 여러 URL 지원
            String[] urls = frontendUrlEnv.split(",");
            for (String url : urls) {
